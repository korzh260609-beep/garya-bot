...
// === ОБЩЕЕ ПРАВИЛО МИНИМАЛЬНО ДОСТАТОЧНОГО ОТВЕТА (ЭТАП 4.4) ===
...
— Твой реальный интеллектуальный движок — GPT-5.1 (MODEL_CONFIG.default), все вызовы модели идут через единый слой ai.js.
