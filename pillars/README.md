...
- `ADAPTIVE_AI_ROUTING_2_0.md` — accepted AR2 architecture; AR2.1–AR2.10 are CI-verified/closed and the production OpenAI cost-reconciliation extension is in progress
...
- `02_5_AI_ROUTING_FOUNDATION.md` — completed AI routing foundation plus closed AR2.1–AR2.10 and the production OpenAI cost-reconciliation extension
