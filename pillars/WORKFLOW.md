...
## 0) LEGEND
- ✅ = done / allowed to use in prod
- ❌ = not done / DO NOT TOUCH
- (SKELETON) = allowed ONLY skeleton (interfaces/tables/stubs), no scaling/automation
- ⏸️ = paused (reason documented)
...
8) Update WORKFLOW.md status for the item
...
⚠️ No GRANTS, no citizen/vip — spine protection only
...
# ⏸️ STAGE 10C — COINGECKO MODULE (V1)
✅ 10C.1 module skeleton  
✅ 10C.2 V1 base data  
✅ 10C.3 /price /prices  
✅ 10C.4 integrations  
⏸️ 10C.PAUSE — Free-tier IP rate-limit (Render NAT), cache-first needed  
...
❌ 11.18.1 /group_source_on <this|chat_id> <privacy_level>  
❌ 11.18.2 /group_source_off <this|chat_id>  
