...
export async function handleCoreDiag(ctx = {}) {
  ...
  if (!isPrivateChat) {
    ...
    return { handled: true, ok: true, stage: "7B.diag_core", result: "private_only_block", cmdBase };
  }
  ...
  if (!isMonarchUser) {
    ...
    return { handled: true, ok: true, stage: "7B.diag_core", result: "monarch_only_block", cmdBase };
  }
  ...
  try {
    ...
    return { handled: true, ok: true, stage: "7B.diag_core", result: "diag_core_replied", cmdBase };
  } catch (e) {
    ...
    return { handled: true, ok: false, reason: "diag_core_failed", cmdBase };
  }
}
