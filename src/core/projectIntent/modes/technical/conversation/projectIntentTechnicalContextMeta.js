// src/core/projectIntent/modes/technical/conversation/projectIntentTechnicalContextMeta.js
// ============================================================================
// TECHNICAL MODE CONVERSATION CONTEXT META
//
// INTERFACE MODE NOTE:
// - This module builds metadata for legacy Technical Mode repo conversation
//   replies and follow-up context.
// - This is not Human Mode intelligence.
// - Future Human Mode context metadata must live behind a separate Human boundary.
// ============================================================================
