// src/core/projectIntent/modes/technical/conversation/projectIntentTechnicalHumanReplies.js
// ============================================================================
// TECHNICAL MODE HUMAN-STYLE REPLY TEMPLATES
//
// INTERFACE MODE NOTE:
// - These are human-readable reply templates for legacy Technical Mode repo
//   conversation flows.
// - Despite the old name "HumanReplies", this is NOT full Human Mode.
// - Future Human Mode reply templates must live behind a separate Human boundary.
// ============================================================================
