...
// ============================================================================
// TECHNICAL MODE PROJECT INTENT ROUTE
//
// INTERFACE MODE NOTE:
// - This is the explicit Technical Mode route boundary for legacy projectIntent.
// - It routes based on the Technical Mode scope classifier.
// - This is not a Human Mode semantic router.
// - Do not add new phrase-bound Human Mode behavior here.
// ============================================================================

import { resolveProjectIntentMatch } from "./projectIntentTechnicalScope.js";
