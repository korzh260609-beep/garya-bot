...
- если показываешь список файлов и папок, сначала укажи repo и ветку;
- папки и файлы показывай отдельными блоками;
- каждый элемент показывай с новой строки;
- папки отмечай как 📁 name/;
- файлы отмечай как 📄 name;
