...
import { createObservabilityEvidenceSource, createDeploymentEvidenceSource } from './sourceAdapters.js';
...
const service = createDiagnosticService({ store, observabilitySource, deploymentSource, environment, revision });
...
process.stdout.write(`${JSON.stringify({ status: 'sg-diagnostics-ready', ...address, environment, revision })}\n`);
