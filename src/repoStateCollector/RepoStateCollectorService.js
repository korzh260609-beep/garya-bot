...
export class RepoStateCollectorService {
  ...
  async runScan(options = {}) {
    ...
    const snapshot = {
      ...
      refSha: treeResult.refSha || null,
      headCommitSha: treeResult.headCommitSha || null,
      commitSha: treeResult.commitSha || treeResult.headCommitSha || null,
      treeSha: treeResult.treeSha || null,
