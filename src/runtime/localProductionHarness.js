...
export function createLocalProductionHarness({ env = {}, interpretationResolver, fetchImpl = globalThis.fetch, clock = () => new Date() } = {}) {
  ...
  const resources = persistence ? [persistence, store, connectionDeployment.resource, controlPlane.eventBus, memory2Resource, selfKnowledgeResource, costReconciliation] : [connectionDeployment.resource, controlPlane.eventBus, memory2Resource, selfKnowledgeResource];
