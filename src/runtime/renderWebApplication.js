...
export async function createRenderWebApplication({ env = process.env, fetchImpl = globalThis.fetch, harnessFactory = createLocalProductionHarness } = {}) {
  ...
  const deliveryDeployment = createDeploymentDeliveryRouter({ persistence: harness.persistence, userSettingsService: harness.userSettingsService, resourceAuthorityRegistry: harness.resourceAuthorityRegistry, connectionRegistry: harness.connectionRegistry, connectionAccessContext: harness.connectionAccessContext, observability: harness.observability });
